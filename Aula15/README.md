...
$$
𝐽^{-1} = \begin{bmatrix}
\frac{𝑑𝑓_𝑞_1}{𝑑𝑥} & \frac{𝑑𝑓_x}{𝑑𝜃_2} \\ 
\frac{𝑑𝑓_𝑞_2}{𝑑𝑦} & \frac{𝑑𝑓_y}{𝑑𝜃_2} \\ 
\frac{𝑑𝑓_𝑞_3}{𝑑𝑧} & \frac{𝑑𝑓_z}{𝑑𝜃_2} \\ 
\end{bmatrix} = \begin{bmatrix}
-𝑙_1sen⁡(𝜃_1)-𝑙_2sen⁡(𝜃_1+𝜃_2) & -𝑙_2sen(𝜃_1+𝜃_2) \\ 
𝑙_1cos(𝜃_1)+𝑙_2cos⁡(𝜃_1+𝜃_2) & 𝑙_2cos⁡(𝜃_1+𝜃_2)\\ 
0 & 0\\ 
...
$$
𝐽 = \begin{bmatrix}
\frac{𝑑𝑓_{𝑞_1}}{𝑑𝑞_𝑥} & ⋯ & \frac{𝑑𝑓_𝑞_1}{𝑑𝑞_R_z} \\ 
⋮ & ⋱ & ⋮ \\ 
\frac{𝑑𝑓_{𝑞_n}}{𝑑𝑞_1} & ⋯ & \frac{𝑑𝑓_{𝑞_𝑛}}{𝑑𝑞_R_z}\\ 
\end{bmatrix} 
$$
